...
public class TextWidgetFieldAssist extends Composite {
	...
	private ContentProposalAdapterCustom adapter;
	...
	public TextWidgetFieldAssist(final Composite parent, final int style, final boolean nullable) {
		super(parent, style);
	...
	public TextWidgetFieldAssist(final Composite parent, final boolean nullable) {
	...
	protected void createTextWidget() {
		...
		adapter = new ContentProposalAdapterCustom(textControl, new TextContentAdapter(), provider, null, null, false);
		adapter.setFilterStyle(ContentProposalAdapterCustom.FILTER_CUMULATIVE);
		adapter.setProposalAcceptanceStyle(ContentProposalAdapterCustom.PROPOSAL_REPLACE);
	...
	public void setChoices(final String[] strings) {
		provider.setProposals(strings);
	}
